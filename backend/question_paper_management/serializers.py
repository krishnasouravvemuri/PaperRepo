...
from core.client_model_app.models import ExamSlot, ExamType, Semester
...
class CreateQuestionPaperSerializer(serializers.Serializer):
    ...
    question_paper_exam_slot = serializers.ChoiceField(choices=ExamSlot.choices)
...
class UpdateQuestionPaperSerializer(serializers.Serializer):
    ...
    question_paper_exam_slot = serializers.ChoiceField(choices=ExamSlot.choices, required=False)
